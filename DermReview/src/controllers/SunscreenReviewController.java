...
public class SunscreenReviewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
    	...
    	System.out.println("Sunscreen"+Main.brand);
    	String username = Main.username;
		user.setText(username);	
    	
    	/* ++++++ Add Review Area ++++++ */
    	FXMLLoader fxmlLoader = new FXMLLoader();
		fxmlLoader.setLocation(getClass().getResource("/fxml/AddSunscreenReview.fxml"));
